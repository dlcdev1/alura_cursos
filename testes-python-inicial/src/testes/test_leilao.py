...
class TestLeilao(TestCase):
    ...
    def test_deve_retornar_o_maior_e_o_menor_valor_em_ordem_quando_adicionado_em_ordem_crescente(self):
    ...
    def test_deve_retornar_o_maior_valor_de_um_lance_de_tres_usuario(self):
    ...
    def test_nao_deve_permitir_propor_lance_caso_o_usuario_seja_o_memo(self):
